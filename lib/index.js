...
const Config = z.object({
	...
	aliyunAsrSampleRate: z.natural().min(8e3).default(16e3),
...
async function createSecretaryAsr(ctx, audio, config) {
	...
	if (credential === void 0) return new Response(JSON.stringify({ error: `${config.aliyunNlsTokenEnv} is not configured` }), {
		status: 503,
		headers: { "content-type": "application/json; charset=utf-8" }
	});
...
//#endregion
export { Config, apply, createAliyunAsrTranscript, createMiniMaxSpeech, createRealtimeClientSecret, inject, name };
