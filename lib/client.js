window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function WechatAssistantWorkspace({ useSessions, workspace, settings, resolveSession, send, t }) {
			...
			const recognition = (0, react.useRef)(null);
			...
			const startBrowserCall = () => {
				...
				engine.onresult = (event) => {
					...
					for (let index = event.resultIndex; index < event.results.length; index += 1) {
						...
						if (result?.isFinal === true) final += result[0].transcript;
						else if (result !== void 0) interim += result[0].transcript;
					}
					if (final !== "") {
				...
				engine.onend = () => {
					if (recognition.current === engine && !recognitionPaused.current) try {
						engine.start();
					} catch {
						stopCall();
					}
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("aside", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("workspace.title") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { className: session === void 0 ? WechatAssistantWorkspace_module_css_default.offlineDot : WechatAssistantWorkspace_module_css_default.onlineDot }), session === void 0 ? t("status.offline") : t("status.connected")] })]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
							className: WechatAssistantWorkspace_module_css_default.connection,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("i", { className: session === void 0 ? WechatAssistantWorkspace_module_css_default.offlineDot : WechatAssistantWorkspace_module_css_default.onlineDot }), session === void 0 ? t("status.noSession") : t("status.currentSession")]
						})
					]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									calling && conversation === "chatgpt" && (liveUserActive || liveUserText !== "") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LiveVoiceRow, {
										mine: true,
										text: liveUserText,
										level: audioLevel,
										agentRole: active.role,
		...
		const en = {
			...
			"conversation.self": "Me and Secretary",
			"conversation.teacher": "Teacher Agent",
			"conversation.claude": "Claude",
			"conversation.chatgpt": "ChatGPT",
			"conversation.self.subtitle": "Direct conversation",
